Klient - En klient skickar förfrågningar till en server som svarar på dom förfrågningarna. Det är internet uppkopplingen som gör kommunicationen mellan en klient och en server möjlig.
